...
> It must be taken into account that these plots will only be generated if at least 1 (or 2 for the case of emap and go plots) enriched term, either GO or KEGG, is found. If no plot is generated, the pdf file with be blank and not openable.
